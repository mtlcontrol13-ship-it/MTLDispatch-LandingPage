      ...
      <div className="2xl:max-w-7xl xl:max-w-5xl flex md:flex-row flex-col items-center justify-evenly w-full mx-auto gap-12">
        ...
        <div className="space-y-6 max-w-2xl">
          ...
          <p className="md:text-lg text-md text-gray-600 leading-relaxed">
            Transform your chauffeur business with our comprehensive admin
            panel. Manage bookings, track drivers in real-time, handle
            invoicing, and deliver exceptional service—all from one intuitive
            platform designed specifically for premium transportation services.
          </p>
          ...
          <div className="flex flex-col space-y-6 pt-4">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Monitor your entire fleet with live GPS tracking. Optimize
                  routes, reduce wait times, and ensure passenger safety with
            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Streamline reservations with automated dispatch, instant
                  confirmations, and seamless customer communication. Handle
                  invoicing and statements effortlessly.
                </p>
              </div>
            </div>
          </div>
